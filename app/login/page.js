  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-900 text-white">
      ...
      <VStack>
        ...
        <div className="w-full h-16 bg-slate-800 flex items-center justify-center shadow-md">
          <div className="w-[95%] flex items-center justify-between">
            ...
            <Button colorPalette="blue" variant="ghost" size="md" rounded="lg">
              Sign Up
            </Button>
          </div>
        </div>
      ...
      <VStack marginTop="32">
        {/* Login Card */}
        <Box>
          <Card.Root flexDirection="row" overflow="hidden" maxW="5xl" rounded="xl" shadow="lg" bg="#1E293B">
            <Image
              objectFit="cover"
              maxW="400px"
              ...
              <Card.Body>
                ...
                <HStack marginTop="5">
                    <InputGroup startElement={<LuLock />}>
                        <PasswordInput placeholder="Password" variant="outline" rounded="lg" borderWidth="2px" minW="300px" borderColor="teal.800" _focus={{borderColor: "teal.600"}}/>
                    </InputGroup>
                </HStack>
